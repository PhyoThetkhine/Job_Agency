...
<body class="bg-light">
    <div class="container mt-5">
        ...
        <div class="form-box">
            <form action="docompanyRegister" method="post" onsubmit="return validatePasswords();">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="password" name="company_password" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="address" placeholder="no,street" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="no_of_employees" name="no_of_employees" required>
